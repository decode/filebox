...
defbindings("WScreen", {
    ...
    kpress(META..ALTMETA.."period", "WScreen.switch_prev(_)"),
    kpress(META..ALTMETA.."comma", "WScreen.switch_next(_)"),
...
--]]    
    ...
    kpress(META..SHIFT.."I", "panel.ask_message(_)"),
    kpress(META..SHIFT.."O", function ()  -- clear notification
...
defmenu("mainmenu", {
    ...
    menuentry("Create WorkSpace...",      "mod_query.query_workspace(_)"),
    menuentry("Run exec...", 	"mod_query.query_exec(_)"),
