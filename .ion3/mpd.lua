...
defbindings("WScreen", {
  kpress(CTRL.."KP_6", "MusicPD.next()"),
  kpress(CTRL.."KP_4", "MusicPD.previous()"),
  kpress(CTRL.."KP_2", "MusicPD.volume_down()"),
  kpress(CTRL.."KP_8", "MusicPD.volume_up()"),
  kpress(CTRL.."KP_5", "MusicPD.toggle_play()"),
  kpress(CTRL.."KP_7", "MusicPD.toggle_repeat()"),
  kpress(CTRL.."KP_9", "MusicPD.toggle_random()"),
  kpress(CTRL.."KP_0", "MusicPD.stop()")
})
